...
The 200 catalogue entries live in banking200.json (extracted verbatim from the
original source). Each entry is a Simple-mode input plus the catalogue metadata
it came from; the Simple-mode engine does the financial work here, exactly as
it does for a product a user creates by hand.
"""
...
_DATA = Path(__file__).with_name("banking200.json")
